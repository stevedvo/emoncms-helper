<?php
	return [
		...
		'defrostDewpointMin'       => env("NIBE_DEFROST_DEWPOINT_MINIMUM", -3),
		'defrostDewpointMax'       => env("NIBE_DEFROST_DEWPOINT_MAXIMUM", 5),
		'defrostEvaporatorMax'     => env("NIBE_DEFROST_EVAPORATOR_MAXIMUM", -15),
		...
		'loadCompTempOff'          => env("NIBE_LOAD_COMP_TEMP_OFF", 21.5),
